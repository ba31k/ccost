...
- **период при старте** и **прайс-таблица** обеих платформ.
...
инкрементальный парсер дочитывает только новые байты. Снапшот
автоматически сбрасывается при смене формата или прайс-таблиц.
